...
root.use('/category_skill', categorySkillsRouters)
root.use('/skill', skillsRouters)
root.use('/category_project', categoryProjectsRouters)
root.use('/project', projectsRouters)
